...
class QuillEditor extends StatefulWidget {
  ...
  factory QuillEditor({
    ...
    //
    return QuillEditor._(focusNode: focusNode, scrollController: scrollController, controller: controller, key: key);
  }

  const QuillEditor._({required this.focusNode, required this.scrollController, required this.controller, super.key});
...
class QuillEditorState extends State<QuillEditor> implements EditorTextSelectionGestureDetectorBuilderDelegate {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context).copyWith(
        textTheme: TextTheme(
            bodySmall:
                TextStyle(color: Theme.of(context).brightness == Brightness.light ? const Color(0xff3a3a3a) : Colors.white)));
    ...
    final showSelectionToolbar = configurations.enableInteractiveSelection && configurations.enableSelectionToolbar;
        ...
        child: QuillEditorBuilderWidget(
          ...
          child: QuillRawEditor(
            ...
            configurations: QuillRawEditorConfigurations(
              ...
              enableMarkdownStyleConversion: configurations.enableMarkdownStyleConversion,
  ...
  void onSingleTapUp(TapDragUpDetails details) {
    ...
    try {
      if (delegate.selectionEnabled && !_isPositionSelected(details)) {
        final platform = Theme.of(_state.context).platform;
        if (isAppleOS(platform: platform, supportWeb: true) || isDesktop(platform: platform, supportWeb: true)) {
