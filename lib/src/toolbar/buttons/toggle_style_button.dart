    ...
    switch (widget.attribute.key) {
      ...
      case 'italic':
        return (
          context.loc.italic,
          SvgPicture.asset(
            'assets/icons/text_style_toolbar/italic_icon.svg',
            fit: BoxFit.scaleDown,
            colorFilter: ColorFilter.mode(
                currentStateValue
                    ? Theme.of(context).brightness == Brightness.light
      ...
      case 'underline':
        return (
          context.loc.underline,
          SvgPicture.asset(
            'assets/icons/text_style_toolbar/underline_icon.svg',
            fit: BoxFit.scaleDown,
            colorFilter: ColorFilter.mode(
                currentStateValue
                    ? Theme.of(context).brightness == Brightness.light
      ...
      case 'strike':
        return (
          context.loc.strikeThrough,
          SvgPicture.asset(
            'assets/icons/text_style_toolbar/strikethrough_icon.svg',
            fit: BoxFit.scaleDown,
            colorFilter: ColorFilter.mode(
                currentStateValue
                    ? Theme.of(context).brightness == Brightness.light
      ...
      case 'list':
        if (widget.attribute.value == 'bullet') {
          return (
            context.loc.bulletList,
            SvgPicture.asset(
              'assets/icons/text_style_toolbar/bullet_paragraph.svg',
              fit: BoxFit.scaleDown,
              colorFilter: ColorFilter.mode(
                  currentStateValue
                      ? Theme.of(context).brightness == Brightness.light
        ...
        return (
          context.loc.numberedList,
          SvgPicture.asset(
            'assets/icons/text_style_toolbar/number_paragraph.svg',
            fit: BoxFit.scaleDown,
            colorFilter: ColorFilter.mode(
                currentStateValue
                    ? Theme.of(context).brightness == Brightness.light
      ...
      case 'align':
        return switch (widget.attribute.value) {
          'left' => (
              ...
              SvgPicture.asset(
                'assets/icons/text_style_toolbar/left_alignment.svg',
                fit: BoxFit.scaleDown,
                colorFilter: ColorFilter.mode(
                    currentStateValue
                        ? Theme.of(context).brightness == Brightness.light
          ...
          'right' => (
              context.loc.alignRight,
              SvgPicture.asset(
                'assets/icons/text_style_toolbar/right_alignment.svg',
                fit: BoxFit.scaleDown,
                colorFilter: ColorFilter.mode(
                    currentStateValue
                        ? Theme.of(context).brightness == Brightness.light
          ...
          'center' => (
              ...
              SvgPicture.asset(
                'assets/icons/text_style_toolbar/center_alignment.svg',
                fit: BoxFit.scaleDown,
                colorFilter: ColorFilter.mode(
                    currentStateValue
                        ? Theme.of(context).brightness == Brightness.light
          ...
          null => (
              ...
              SvgPicture.asset(
                ...
                fit: BoxFit.scaleDown,
                colorFilter: ColorFilter.mode(
                    !_getIsToggled({Attribute.align.key: Attribute.color})
                        ? Theme.of(context).brightness == Brightness.light
                            ? Colors.white
                            : Colors.black
                        : Theme.of(context).textTheme.headlineSmall!.color!,
